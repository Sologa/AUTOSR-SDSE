...
# python docs/codex/test/run_codex_single.py --run-id 20260110_090000 --codex-bin /opt/homebrew/bin/codex
python docs/codex/test/run_codex_single.py --run-id 20260110_090000
```
...
## 輸出檔案
所有輸出會寫入：`docs/codex/test/outputs/<run_id>/`
- `codex_single.json`
- `gemini_single.json`
- `full_workflow.json`
- `run_manifest.json`
...
## 驗證輸出
```bash
python docs/codex/test/validate_review_output.py docs/codex/test/outputs/<run_id>/codex_single.json
python docs/codex/test/validate_review_output.py docs/codex/test/outputs/<run_id>/gemini_single.json
python docs/codex/test/validate_review_output.py docs/codex/test/outputs/<run_id>/full_workflow.json
python docs/codex/test/validate_run_manifest.py docs/codex/test/outputs/<run_id>/run_manifest.json
```
